...
POS1 = Vm*t^2/t1- Vm*t^3/(3*t1^2);
POS2 = Vm*tb^2/t1 - Vm*tb^3/(3*t1^2) + Vm*(t-tb);
POS3 = Vm*tb^2/t1 - Vm*tb^3/(3*t1^2) + Vm*(tc-tb) + Vm*(t-tc) - Vm*(t-tc)^3/(3*t3^2);
